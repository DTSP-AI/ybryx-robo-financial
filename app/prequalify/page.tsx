                ...
                <div className="border rounded-lg p-4 space-y-4">
                  <div className="flex items-start space-x-3">
                    ...
                    <label htmlFor="consent" className="text-sm leading-relaxed cursor-pointer">
                      I authorize Bolt.new and its lending partners to perform a soft credit inquiry and contact me regarding my equipment lease application. I understand this will not affect my credit score and I consent to receive communications via phone, email, and SMS.
                    </label>
                  </div>
                </div>
