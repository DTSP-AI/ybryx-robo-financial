    ...
    <footer className="bg-neutral-900 text-white">
      <div className="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8 py-12">
        <div className="grid grid-cols-1 md:grid-cols-4 gap-8">
          <div>
            <div className="flex items-center space-x-2 mb-4">
              ...
              <span className="text-xl font-bold">Ybryx Capital</span>
            </div>
          ...
          <div>
            ...
            <ul className="space-y-2 text-sm text-neutral-400">
              ...
              <li><a href="mailto:contact@ybryxcapital.com" className="hover:text-white transition-colors">Contact Sales</a></li>
            </ul>
          </div>
        </div>
        ...
        <div className="border-t border-neutral-800 mt-12 pt-8 flex flex-col md:flex-row justify-between items-center text-sm text-neutral-400">
          <p>&copy; 2025 Ybryx Capital. All rights reserved.</p>
